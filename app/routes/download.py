...
def download_profiles(server_cn, common_name):
    ...
    if not username:
        ...
        return jsonify({"success": False, "msg": "Downloading profiles from other users is not allowed"}), 403
        ...
        return jsonify({"success": False, "msg": "Profile common_name doesn't exist"}), 404
